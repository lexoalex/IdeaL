...
$page_view = views_get_current_view(); 
$display_id = $page_view->current_display;
//$view_results = views_get_view_result($page_view, $display_id);
//dpm($page_view->result);
//foreach($page_view->result as $key => $result) {
...
<div class="vud-widget vud-widget-updown" id="<?php print $id; ?>">
  ...
  <?php if (!($node && $flag->is_flagged($node->nid)) && arg(0) !=  'in-action'): ?>
